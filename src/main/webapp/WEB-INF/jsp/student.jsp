    ...
    <body style="padding: 20px">
        <form:form modelAttribute="student" method="post" action="/Spring_0117/mvc/student/${action}" class="pure-form">
            <fieldset>
                ...
                <form:input path="date" placeholder="請輸入date" readonly="true" /> <form:errors path="date" style="color: red" /><p />                <button type="submit" class="pure-button pure-button-primary">${action}</button>
            </fieldset>
        </form:form>
